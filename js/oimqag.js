        ...
        i.define({
            ...
            i.define({
                ...
                dc: {
                    type: 1,
                    value: function(t) {
                        return t.adInfo && 'ssp' === t.adInfo.platformType || '114042' === t.deliveryInfo.exps || '114022' === t.deliveryInfo.exps ? 3 : 2
                    }
                },
                dtm: {
                    type: 1,
            ...
            i.define({
                ...
                $material: function() {
                    ...
                    this.materialFactory = {},
                        ...
                        this.materialFactory.slide = function(e, i) {
                            ...
                            e.html = '<div>' + r.join('</div><div>') + '</div>';
                            var c = i.response.placement,
                                l = c.container;
                ...
                createImg: function(t) {
                    ...
                    return t.imageWidth > 0 && (e += ' width="' + t.imageWidth + '"'),
                    t.imageHeight > 0 && (e += ' height="' + t.imageHeight + '"'),
                    e + ' /></a>'
                },
            ...
            i.define({
                ...
                render: function(t) {
                    ...
                    return n.innerHTML = m,
                    this.random.getBool(30) && n.removeAttribute && n.removeAttribute('id'),
                    this.random.getBool(80) && n.removeAttribute && n.removeAttribute('style'),
                    !t.adInfo || 'ssp' !== t.adInfo.platformType && '114022' !== t.deliveryInfo.exps || window.postMessage && this.dom.bind(window, 'message', i.proxy(this, this.messageHandler, t)),
                        !0
                },
                messageHandler: function(t, e) {
                    if (t.data) {
                        ...
                        if (i && i.placement && i.placement.update && i.queryid && i.tuid && n === i.tuid) {
                            ...
                            var u = this.material.formatMaterial(l);
                            if (a && '0' !== a.deliv_id && '0' === i.noadx);
                            else if (s && '0' !== s.deliv_id && '0' === i.noadx);
                            else if (o && c && l) if ('rich' === d) {
                                var p = document.createElement('iframe'),
                                    m = p.contentWindow.document;
                                r.innerHTML = '',
                                    r.appendChild(p),
                                u.indexOf('<body>') < 0 && (u = '<!DOCTYPE html><body>' + u),
                                    m.open(),
                                    m.write(u),
...
} catch(t) { (new Image).src = "//eclick.baidu.com/se.jpg?type=remote&date=0115&mes=" + encodeURIComponent(t.stack)
}